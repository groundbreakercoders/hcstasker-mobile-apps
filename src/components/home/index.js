        ...
        <Content scrollEnabled={false}>
          ...
          >
            <View style={{ flex: 1, flexDirection: "column" }}>
              <SearchLocation
                page={this.props.userPageStatus}
                onpress={() => this.props.setUserPageStatus("home")}
                currentLocation={{
                  onPress: this.props.openTripLocationSearch,
                  value: this.props.origin && this.props.origin.name,
                ...
                /> 
                  ...
                  {_.map(this.state.markers, (marker, index) => (
                   ...
                   {/* <MapViewDirections
                      ...
                      destination = {this.state.markers[1].latlng}
                      apikey = "AIzaSyDhoM9JnelVUIJYtS2RZh0SALbBpJ6sdWs"
                      strokeWidth = {4}
                      strokeColor = "#4AC0F7"
                    /> */}
              ...
              {this.props.userPageStatus === "home" ? (
                <CategoryAndSubCategory strings={strings} />
              ) : null}
